...
## Release process
`Release candidate` runs only for a `v*` tag or manual dispatch. It produces unsigned evidence: a release APK, a release AAB, R8 mapping file, SHA-256 manifest, and SPDX JSON SBOM.
